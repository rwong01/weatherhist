...
export const VARIABLES = [
  { id: 'wind_speed_max', label: 'Max wind speed (10 m)', short: 'Max wind speed', hourly: 'wind_speed_10m', agg: 'max', unit: 'mph', decimals: 1 },
  { id: 'wind_gust_max', label: 'Max wind gust (10 m)', short: 'Max wind gust', hourly: 'wind_gusts_10m', agg: 'max', unit: 'mph', decimals: 1 },
  { id: 'temp_max', label: 'Max temperature (2 m)', short: 'Max temperature', hourly: 'temperature_2m', agg: 'max', unit: '°F', decimals: 1 },
  { id: 'temp_min', label: 'Min temperature (2 m)', short: 'Min temperature', hourly: 'temperature_2m', agg: 'min', unit: '°F', decimals: 1 },
  { id: 'precip_total', label: 'Total precipitation', short: 'Daily precipitation', hourly: 'precipitation', agg: 'sum', unit: 'in', decimals: 2 },
  { id: 'humidity_mean', label: 'Mean relative humidity (2 m)', short: 'Mean relative humidity', hourly: 'relative_humidity_2m', agg: 'mean', unit: '%', decimals: 1 },
];
